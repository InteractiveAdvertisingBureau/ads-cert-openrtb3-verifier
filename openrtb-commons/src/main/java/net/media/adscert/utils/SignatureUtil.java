...
public class SignatureUtil {
  ...
  private static Key getKey(String keyPEM, Function<byte[], KeySpec> f1, Function<KeySpec, Key> f2)
  ...
  private static PrivateKey getPrivateKeyFromString(String privateKeyPEM)
    ...
    //    KeyFactory kf = KeyFactory.getInstance("EC");
    //    return (PrivateKey) getKey(privateKeyPEM, PKCS8EncodedKeySpec::new,
