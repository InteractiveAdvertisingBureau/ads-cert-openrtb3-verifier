...
public class FileVerificationService {
   ...
   * @param mapper {@link ObjectMapper} to be used for converting JSON to an {@link OpenRTB3_X} object
          ...
          line -> {
            try {
              outputStream.write(
                  ((service
                              .verifyRequest(
                                  mapper.readValue(line, OpenRTB3_X.class), false, publicKey, false)
                              .getStatus()
                              .name())
